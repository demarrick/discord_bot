...
token='MTEwMjkwODA2MjMyNDQ5ODUwNA.G6i5Z7.XN4gwxLyDgLtYIUK_pk4XyQLgzRNnfAClPJwVw'
...
async def on_ready():
     ...
     channel=client.get_channel(1102906716892450848)
...
async def on_message(message):
     if message.author != client.user:
          ...
          if '/ciao' in message.content:
              ...
              voice_channel=client.get_channel(1102906716892450849)
              channel=client.get_channel(1102906716892450848)
